...
import { CreateClientPageComponent } from './features/products/pages/create-client-page/create-client-page.component';
...
const routes: Routes = [
  ...
  { path: 'create-client', component: CreateClientPageComponent, canActivate: [GuardGuard] },
